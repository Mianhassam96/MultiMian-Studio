      ...
      >
        <div className="container flex items-center justify-between h-18 md:h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group shrink-0" aria-label="MultiMian Studio home">
            <span className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-primary-dark shadow-glow flex items-center justify-center font-extrabold text-white text-xl group-hover:scale-110 transition-transform duration-300">
              M
            </span>
          ...
          <nav className="hidden md:flex items-center gap-1" aria-label="Main navigation">
            {NAV_LINKS.map(({ href, label }) => (
              ...
              >
                ...
                <span
                  className={`absolute bottom-0.5 left-3 right-3 h-0.5 rounded-full bg-gradient-to-r from-primary to-[var(--accent-cyan)] transition-all duration-300
